 ...
 */
public class PureCyanLit extends Block {
    public PureCyanLit() {
        super(Material.WOOD);

        setUnlocalizedName("purecyanlit");
        setResistance(100F);
        setHardness(0.5F);
        setRegistryName("purecyanlit");
    ...
    {
        return Item.getItemFromBlock(ModBlocks.purecyan);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModBlocks.purecyan);
    }
